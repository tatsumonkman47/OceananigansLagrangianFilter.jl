...
#   test_spatial_cutoff_integration.jl - one independent trajectory-kernel check
...
include("test_online_cutoff_mask.jl")
include("test_spatial_cutoff_integration.jl")
